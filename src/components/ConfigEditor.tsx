...
const inputClass =
  'w-full rounded-md border border-slate-300 px-2 py-1 text-sm focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500';
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <span className="text-sm text-slate-500">{filtered.length} fields</span>
      </div>

      <div className="space-y-3">
        {filtered.map((field) => (
          <div key={field.code} className="rounded-lg border border-slate-200 bg-white p-4">
